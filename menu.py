...
# 2. Set up a function to add items to the order list
...
def welcome(): print("Welcome to the variety food truck.")
welcome()
...
while True: 
    if keep_ordering.lower() == "y": 
        ...
        menu_category = input("Please select a menu category number: 1 - 4 ")
        i = 1
        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit(): 
                ...
                if int_menu_selection in menu_items.keys(): 
                    ...
                    item_name = menu_items[int_menu_selection]["Item name"]
                    ...
                    add_to_order(item_name, menu_items[int_menu_selection]["Price"], quantity)
...
cost = sum([item["Price"] * item["Quantity"] for item in order_list])

# Multiply the price by quantity for each item in the order list, then sum()
calc_cost = sum([item["Price"] * item["Quantity"] for item in order_list])
